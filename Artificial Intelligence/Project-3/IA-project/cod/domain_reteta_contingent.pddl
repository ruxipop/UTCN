...
(:predicates 
    ...
    (stricat_i1 ?i1 - ingredient1)
    (stricat_i2 ?i2 - ingredient2)
    (stricat_i3 ?i3 - ingredient3)
...
(:action sense_stricat_i1 
 :parameters (?i1 - ingredient1)
 :precondition (and (not (nu_are_i1 ?i1))) ;are i1 la el
 :observe (stricat_i1 ?i1)
)

(:action sense_stricat_i2 
 :parameters (?i2 - ingredient2)
 :precondition (and (not (nu_are_i2 ?i2))) ;are i2 la el
 :observe (stricat_i2 ?i2)
)



(:action sense_stricat_i3 
 :parameters (?i3 - ingredient3)
 :precondition (and (not (nu_are_i3 ?i3))) ;are i3 la el
 :observe (stricat_i3 ?i3)
)
...
(:action arunc_i1_stricat
    :parameters (?i1 - ingredient1)
    :precondition (and (not (nu_are_i1 ?i1)) ;are i1
                       (stricat_i1 ?i1) )  ;e stricat
    :effect(nu_are_i1 ?i1) ;arunca i1
)

(:action arunc_i2_stricat
    :parameters (?i2 - ingredient2)
    :precondition (and (not (nu_are_i2 ?i2)) ;are i2
                       (stricat_i2 ?i2) )  ;e stricat
    :effect(nu_are_i2 ?i2) ;arunca i2
)

(:action arunc_i3_stricat
    :parameters (?i3 - ingredient3)
    :precondition (and (not (nu_are_i3 ?i3)) ;are i3
                       (stricat_i3 ?i3) )  ;e stricat
    :effect(nu_are_i3 ?i3) ;arunca i3
)
...
(:action start_reteta
    ...
    :precondition (and (not (nu_are_i1 ?i1)) ;are i1
                       ...
                       (not (stricat_i1 ?i1)) ;nu e i1 stricat
                       (not (stricat_i2 ?i2)) ;nu e i2 stricat
                       (not (stricat_i3 ?i3))) ;nu e i3 stricat 
