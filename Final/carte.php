...
<?php
    ...
    $query ="SELECT id_carte,titlu,nr_pagini,nr_exemplare,gen
...
echo '<tr><td>'.htmlspecialchars(stripslashes($row['id_carte'])).'</td>';
   echo '<td>'.htmlspecialchars(stripslashes($row['titlu'])).'</td>';
      echo '<td>'.htmlspecialchars(stripslashes($row['nr_pagini'])).'</td>';
         echo '<td>'.htmlspecialchars(stripslashes($row['nr_exemplare'])).'</td>';
   echo '<td>'.htmlspecialchars(stripslashes($row['gen'])).'</td></tr>';
    }
    echo '</table>';
