    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="wish?cont=${cont}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="cart?cont=${cont}">
    ...
    <div class="container py-5">
        <div class="row py-5 ">
            <div class=" text-left">
                ...
                <h2 id="Aranjamente Nuntă" > Aranjamente Nuntă</h2>
    ...
    <div class="container py-5">
        <div class="row py-5 ">
            <div class=" text-left">
                ...
                <h2 id="Criogenați" > Criogenați</h2>
...
<section class="product">
    <div class="container py-5">
        <div class="row py-5 ">
            <div class=" text-left">
                <h2 id="Cutii cu flori" > Cutii cu flori</h2>
            ...
            <c:forEach var="flower" items="${flowers}">
                <c:if test="${flower.categorie=='Funerar'}">
                    <div class="col-lg-1 text-center">
                        ...
                        <div class="card border-0 bg-light mb-2">
                            <div class="card-body" >
                                <button  style="color:black; background:none; border: none; font-weight:bold;" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    <tr>
