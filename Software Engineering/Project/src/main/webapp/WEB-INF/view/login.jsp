        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                            ...
                            <a href="mylogin" style="text-decoration: none">
...
<section class="h-100 h-custom" style="background-color: #d2c9ff;">
                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    <div class="d-flex justify-content-between align-items-center mb-5" >
                                        <h1 class="fw-bold mb-0 text-black" >LOGARE</h1>
    ...
    <c:if test="${param.logout != null}">
        <i style="color:blue">You are successfully logged out!</i>
    </c:if>

    <%--@elvariable id="user" type="com.bianca.model"--%>
    <form:form action="process-login" method="POST">
        <strong>Nume de utilizator</strong> <br><input type="text" name="username"><br>
        <strong>Parolă</strong> <br><input type="password" name="password"><br>

<br>
        <input type="submit" style="background: #49274A; color:white" name="Login">
    </form:form>
    <br>
    <a href="signup"><p>Nu am cont</p></a>
