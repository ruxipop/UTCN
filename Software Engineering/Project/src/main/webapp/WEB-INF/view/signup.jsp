                            ...
                            <div class="col-lg-7">
                                <div class="p-5">
                                    <div class="d-flex justify-content-between align-items-center mb-5" >
                                        <h1 class="fw-bold mb-0 text-black" >Înregistrare</h1>


                                    </div>

                                    <hr class="my-4">
<%--@elvariable id="user" type="com.bianca.model.User"--%>
<form:form action="process-signup" modelAttribute="user" method="post">
<strong>Nume de utilizator</strong><br>
    <form:input path="username"></form:input><br>
<strong>Parolă</strong> <br>
    <form:input path="password" type="password"></form:input><br><br>
<input type="submit" style="background: #49274A; color:white" value="Înregistrare">
</form:form>
