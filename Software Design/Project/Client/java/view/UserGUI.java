...
public class UserGUI implements model.Observer {
    ...
    public UserGUI(ModelUser modelUser, ModelAdmin modelAdmin) throws IllegalAccessException, java.io.IOException {
    ...
    private void fillCategory(JComboBox comboBox) throws java.io.IOException {
        removeCombo(comboBox);
        comboBox.addItem(language.get("buttonSelect"));

        for (String s : this.modelUser.getMovieBLL()
                .typeOfCategory()) {
    ...
    private void fillYear(JComboBox comboBox) throws java.io.IOException {
        ...
        for (Movie movie : this.modelUser.getMovieBLL().getMoviesList()) {
    ...
    private void fillType(JComboBox comboBox) throws java.io.IOException {
        removeCombo(comboBox);
        comboBox.addItem(language.get("buttonSelect"));


        for (String s : this.modelUser.getMovieBLL().typeOfType()) {
    ...
    public void fillAll() throws java.io.IOException {
        fillType(comboType);
        fillYear(comboYear);
        fillCategory(comboCategory);
    }
    ...
    @Override
    public void update(Object o) throws IllegalAccessException, java.io.IOException {
        String s = (String) o;
        switch (s) {
            case "language":
                changeLanguage();
            ...
            case "show":
                ...
                this.setTable(modelUser.getMovieBLL().getMoviesList());
