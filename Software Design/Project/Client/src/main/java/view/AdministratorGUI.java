...
@lombok.Getter
@lombok.Setter
public class AdministratorGUI implements model.Observer {
    ...
    public AdministratorGUI(ModelAdmin modelAdmin) throws IllegalAccessException, java.io.IOException {
    ...
    public void fillRole() throws java.io.IOException {
        removeCombo(comboBox1);
        comboBox1.addItem(language.get("buttonSelect"));

        for (String s : this.modelAdmin.getUserBLL().typeOfRole()) {
    ...
    public void setTable(List<model.User> list) {
    ...
    public void update(Object o) throws IOException {
        ...
        switch (s) {
            case "language":
                ...
                break;
            case "show":
                this.setTable(modelAdmin.getUserBLL().getUsersList());
                this.fillRole();
